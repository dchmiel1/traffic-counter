...
class TestUpdateProject:
    def test_update(self, datastore: Mock, my_project: Project) -> None:
        ...
        assert datastore.project == Project(new_project_name, new_project_start_date)
    ...
    def test_update_name(self, datastore: Mock, my_project: Project) -> None:
        ...
        assert datastore.project == Project(new_project_name, my_project.start_date)
    ...
    def test_update_start_date(self, datastore: Mock, my_project: Project) -> None:
        ...
        assert datastore.project == Project(my_project.name, new_project_start_date)
