...
from traffic_counter.application.geometry import GeometryBuilder
from traffic_counter.domain.geometry import RelativeOffsetCoordinate, apply_offset
from traffic_counter.domain.section import Area, LineSection
