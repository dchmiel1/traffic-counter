...
import traffic_counter.plugin_parser.ottrk_dataformat as ottrk_format
...
from traffic_counter.domain import event, flow, geometry, section, video
from traffic_counter.domain.common import DataclassValidation
from traffic_counter.domain.event import Event, EventType
...
from traffic_counter.domain.video import PATH, SimpleVideo, Video, VideoReader
from traffic_counter.plugin_datastore.python_track_store import (
    PythonDetection,
    PythonTrack,
    PythonTrackDataset,
)
from traffic_counter.plugin_parser import dataformat_versions
