...
from traffic_counter.application.config import DEFAULT_EVENTLIST_FILE_TYPE
from traffic_counter.application.datastore import EventListParser
...
from traffic_counter.plugin_parser.otvision_parser import OtEventListParser
