...
from traffic_counter.application.application import CancelAddSection
from traffic_counter.domain.geometry import RelativeOffsetCoordinate
from traffic_counter.domain.section import ID, NAME, RELATIVE_OFFSET_COORDINATES
...
from traffic_counter.plugin_ui.customtkinter_gui.frame_bbox_offset import FrameBboxOffset
