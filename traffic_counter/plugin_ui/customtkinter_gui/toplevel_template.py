...
from traffic_counter.plugin_ui.customtkinter_gui.constants import PADX, PADY, tk_events
from traffic_counter.plugin_ui.customtkinter_gui.utility_widgets import FrameOkCancel
